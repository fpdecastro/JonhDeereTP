...
if __name__ == "__main__":
    ...
    sql_query = ''' INSERT INTO area( valueAsDouble, unit, id_boundaries)
                    VALUES (?, ?, ?)'''
                ...
                for field in response_field:
                    ...
                    if response_boundaries_value != []:
                        for boundaries in response_boundaries_value:
                            ...
                            valueAsDouble = boundaries['area']['valueAsDouble']
                            unit = boundaries['area']['unit']
                            
                            print(id_organizations,' -------> ',valueAsDouble, unit, id_boundaries)
                            # insert_values = (valueAsDouble, unit, id_boundaries)
                            # cursor.execute(sql_query, insert_values)    
                    else:
                        print(field_id,'---> no tiene campo')
    # cnxn.commit()
