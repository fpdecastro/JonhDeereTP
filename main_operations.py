...
if __name__ == "__main__":
    ...
    sql_query = ''' INSERT INTO operaciones( fieldOperationType, cropSeason, modifiedTime, startDate, endDate, cropName, id_operation, id_field)
                     VALUES (?, ?, ?, ?, ?, ?, ?, ?)'''
                ...
                for field in response_field:
                    ...
                    if response_operation_value != []:
                        for operation in response_operation_value:
                            ...
                            cropName = operation['cropName']
                            id_operation = operation['id']

                            insert_values = (fieldOperationType, cropSeason, modifiedTime, startDate, endDate, cropName, id_operation, field_id)
